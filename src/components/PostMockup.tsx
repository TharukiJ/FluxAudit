  ...
  return (
    <div className="flex flex-col p-6 h-full min-h-[450px]">
      ...
      <div className="relative flex flex-col md:flex-row items-center justify-center gap-12 sm:gap-20 flex-grow p-8 pt-16 sm:p-12 sm:pt-20">
        ...
        >
          {/* Label */}
          <div className="absolute -top-8 left-1/2 -translate-x-1/2 w-max text-[#790604] font-mono text-[10px] sm:text-xs font-bold tracking-widest uppercase">
            [ STATUS: INEFFICIENT ]
          </div>
          ...
          <div className="relative w-[140px] sm:w-[160px] h-[280px] sm:h-[320px] rounded-[28px] border-[8px] border-gray-800 bg-gray-900 overflow-hidden shadow-2xl">
            ...
            <div className="absolute top-1/4 left-1/4 z-20 animate-pulse text-[#790604]">
              <AlertTriangle size={24} />
            </div>
            <div className="absolute bottom-1/3 right-1/4 z-20 animate-pulse text-[#790604] delay-300">
        ...
        >
          {/* Label */}
          <div className="absolute -top-8 left-1/2 -translate-x-1/2 w-max text-[#B2A18F] font-mono text-[10px] sm:text-xs font-bold tracking-widest uppercase animate-pulse shadow-[#B2A18F]/50 drop-shadow-[0_0_8px_rgba(178,161,143,0.8)]">
            [ STATUS: OPTIMIZED ]
          </div>

          <div className="relative w-[150px] sm:w-[170px] h-[300px] sm:h-[340px] rounded-[28px] border-[8px] border-gray-900 bg-black overflow-visible shadow-[0_0_50px_rgba(178,161,143,0.15)] transition-shadow duration-300 hover:shadow-[0_0_80px_rgba(178,161,143,0.4)]">
            ...
            <div className="flex items-center gap-2 p-3 absolute top-0 w-full z-10 bg-gradient-to-b from-black/90 to-transparent pt-4">
              <div className="w-6 h-6 rounded-full bg-[#B2A18F] p-[1px]">
                  <div className="w-full h-full bg-[#0F1C38] rounded-full border border-black flex items-center justify-center">
                    <Sparkles size={10} className="text-[#B2A18F]" />
                  </div>
              </div>
            ...
            <div className="w-full h-full rounded-[20px] bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#0F1C38] via-black to-black overflow-hidden relative">
              ...
              <div className="flex flex-col items-center justify-center h-full px-4 relative z-10 w-full">
                ...
                <div className="text-white font-mono font-black text-center text-[12px] sm:text-sm tracking-tighter leading-snug uppercase mb-16 drop-shadow-[0_5px_5px_rgba(0,0,0,1)] flex flex-col items-center">
                  <span className="bg-[#B2A18F] text-[#0F1C38] px-2 py-0.5 mb-1 rounded-sm">{data.hook.highlight}</span>
              ...
              <div className="absolute bottom-6 left-0 w-full px-4 text-center z-20">
                <div className="relative py-2 rounded-full bg-gradient-to-r from-[#0F1C38] to-[#B2A18F] text-white text-[10px] sm:text-xs font-bold shadow-[0_0_15px_rgba(178,161,143,0.4)] border border-[#B2A18F]">
